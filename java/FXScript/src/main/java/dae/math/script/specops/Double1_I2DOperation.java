 ...
 */
public class Double1_I2DOperation extends AbstractScriptVariable implements I2DValue {
    ...
    public Double1_I2DOperation(String caption, IDouble1Value op1, Operator op, I2DValue op2) {
        this.op1 = op1;
        this.op2 = op2;
        this.op = op;
    ...
    public void update() {
        ...
        switch (op) {
            case TIMES:
                result.set(op2.x() * d1, op2.y() * d1, op2.w());
                break;
            case DIVIDEBY:
                result.set(op2.x() / d1, op2.y() / d1, op2.w());
                break;
