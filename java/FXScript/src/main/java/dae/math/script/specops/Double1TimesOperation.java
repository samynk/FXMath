 ...
 */
public class Double1TimesOperation extends Double1Operation {

    public Double1TimesOperation(String caption, IDouble1Value op1, Operator op, IDouble1Value op2) {
