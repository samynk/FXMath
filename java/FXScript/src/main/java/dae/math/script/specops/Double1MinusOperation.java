 ...
 */
public class Double1MinusOperation extends Double1Operation {

    public Double1MinusOperation(String caption, IDouble1Value op1, Operator op, IDouble1Value op2) {
